...
const StorySection = () => {
  const stories = [
    ...
    },
    {
      ...
      title: 'AI+移动端技术专家',
      avatar: memberXue,
      story: '在北京打拼的这些年，我见证了移动互联网的黄金时代，主导过多个千万级用户的应用开发。但随着行业内卷加剧，我开始思考技术的本质意义。在中国信息通信研究院进行技术沉淀那些日子，我深刻体会到人工智能产业标准化篇章已经开启，当我的老朋友依托他的创新论体系打造X极客网概念时，被这种纯粹的创新精神和1D3S+AI的愿景深深震撼，AI具有人类情感和创造力这个梦想让我无比兴奋。虽然身在北京，但心已经和这个组织紧紧相连。',
      achievement: '成功打造10款移动应用，累计用户超5000万',
